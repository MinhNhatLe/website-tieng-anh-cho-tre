 ...
 // Mở rộng phương thức phần tử
  ...
  //}
    ...
    WordSearch.prototype.gameOver = function () {
        ...
        overlayInner.setAttribute("class", "ws-game-over-inner");
        overlayInner.setAttribute("id", "ws-game-over-inner");

        var overlayContent = document.createElement("div");
        overlayContent.setAttribute("class", "ws-game-over");
        overlayContent.setAttribute("id", "ws-game-over");

        // Create image element.
        var img = document.createElement("img");
        img.setAttribute("src", "/Content/images/gif/phaohoa1.gif");
        ...
        // Append image to overlay content.
        ...
        paragraph.textContent = "You've found all of the words!";

        // Append heading and paragraph to overlay content.
        overlayContent.appendChild(heading);
        overlayContent.appendChild(paragraph);

        // Append overlay content to overlay inner.
        overlayInner.appendChild(overlayContent);

        // Append overlay inner to overlay.
